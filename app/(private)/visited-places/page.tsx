// app/(private)/destinations/page.tsx
...
export default function InterestsPage() {
  ...
  const [interests, setInterests] = useState<VisitedPlacesI[]>([]);
  const [newInterest, setNewInterest] = useState("");
  const [editingInterest, setEditingInterest] = useState<VisitedPlacesI | null>(null);
  ...
  return (
    <div>
      <h1>{session?.user?.name}'s visited-places</h1>
      {loading && <p>Loading...</p>}
